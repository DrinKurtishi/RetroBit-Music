...
</html>ic, Sparkles, Share2, Download } from 'lucide-react';
<!DOCTYPE html>
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
<head>
    <meta charset="utf-8">
...
</html>een bg-gradient-to-b from-purple-900 via-purple-800 to-black text-white">
<!DOCTYPE html>
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
<head>
    <meta charset="utf-8">
...
</html>ems-center justify-between p-6">
<!DOCTYPE html>
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
<head>
    <meta charset="utf-8">
...
</html>xt-2xl font-bold">RetroBit</span>
<!DOCTYPE html>
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
<head>
    <meta charset="utf-8">
...
</html>assName="hover:text-purple-300 transition">Login</a>
<!DOCTYPE html>
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
<head>
    <meta charset="utf-8">
...
</html> className="bg-purple-500 px-4 py-2 rounded-full hover:bg-purple-600 transition">
<!DOCTYPE html>
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
<head>
    <meta charset="utf-8">
...
</html>-5xl font-bold mb-6">Create Music with AI</h1>
<!DOCTYPE html>
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
<head>
    <meta charset="utf-8">
...
</html>xl text-purple-200 mb-12 max-w-2xl mx-auto">
<!DOCTYPE html>
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
<head>
    <meta charset="utf-8">
...
</html>eas into unique tracks using cutting-edge AI technology. 
<!DOCTYPE html>
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
<head>
    <meta charset="utf-8">
...
</html>, harmonies, and complete songs in seconds.
<!DOCTYPE html>
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
<head>
    <meta charset="utf-8">
...
</html>="bg-purple-500 px-8 py-3 rounded-full text-lg font-semibold hover:bg-purple-600 transition flex items-center gap-2">
<!DOCTYPE html>
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
<head>
    <meta charset="utf-8">
...
</html>="bg-purple-900 px-8 py-3 rounded-full text-lg font-semibold hover:bg-purple-800 transition flex items-center gap-2">
<!DOCTYPE html>
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
<head>
    <meta charset="utf-8">
...
</html>md:grid-cols-3 gap-8 mt-24">
<!DOCTYPE html>
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
<head>
    <meta charset="utf-8">
...
</html>purple-900/50 p-6 rounded-xl">
<!DOCTYPE html>
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
<head>
    <meta charset="utf-8">
...
</html>g-purple-500 w-12 h-12 rounded-full flex items-center justify-center mb-4">
<!DOCTYPE html>
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
<head>
    <meta charset="utf-8">
...
</html>xt-xl font-semibold mb-3">Voice to Music</h3>
<!DOCTYPE html>
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
<head>
    <meta charset="utf-8">
...
</html>r melody and watch as AI transforms it into a full composition
<!DOCTYPE html>
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
<head>
    <meta charset="utf-8">
...
</html>xt-xl font-semibold mb-3">Smart Generation</h3>
<!DOCTYPE html>
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
<head>
    <meta charset="utf-8">
...
</html>els understand music theory to create harmonious and original tracks
<!DOCTYPE html>
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
<head>
    <meta charset="utf-8">
...
</html>xt-xl font-semibold mb-3">Easy Sharing</h3>
<!DOCTYPE html>
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
<head>
    <meta charset="utf-8">
...
</html>tions instantly or download high-quality audio files
<!DOCTYPE html>
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
<head>
    <meta charset="utf-8">
...
</html>-3xl font-bold mb-6">Ready to Make Music?</h2>
<!DOCTYPE html>
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
<head>
    <meta charset="utf-8">
...
</html> creators using AI to enhance their music production
<!DOCTYPE html>
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
<head>
    <meta charset="utf-8">
...
</html>bg-purple-500 px-8 py-3 rounded-full text-lg font-semibold hover:bg-purple-600 transition">
<!DOCTYPE html>
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
<head>
    <meta charset="utf-8">
...
</html>er-t border-purple-800 mt-24 py-8 text-center text-purple-300">
<!DOCTYPE html>
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
<head>
    <meta charset="utf-8">
